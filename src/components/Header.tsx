...
import { Menu, X, CircleDot, LayoutDashboard, DollarSign, Sun, Moon, BookOpen } from 'lucide-react';
            ...
            <ToggleGroup type="single" value={activePage} onValueChange={(value) => value && setActivePage(value)}>
              ...
              <Link to="/blog">
                <ToggleGroupItem 
                  ...
                  className={cn(
                    "px-4 py-2 rounded-full transition-colors relative",
                    location.pathname === '/blog' ? 'text-accent-foreground bg-accent' : 'text-muted-foreground hover:text-foreground hover:bg-muted'
                  )}
                >
